...
//    }
    ...
    _pageControl.pageIndicatorTintColor = [UIColor colorWithRed:87.0/255 green:94.0/255  blue:111.0/255 alpha:0.8f];
    ...
    _saveImageBtn.frame = CGRectMake(kMainScreenWidth-btnWidth-20, 0, btnWidth, btnWidth);
