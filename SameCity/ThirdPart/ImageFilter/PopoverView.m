...
+ (void)dismissed
{
    ...
    for (UIView *tmp in topView.subviews) {
        if ([tmp isKindOfClass:[PopoverView class]]) {
            PopoverView *tmp_pop = (PopoverView *)tmp;
            [tmp_pop dismiss];
            break;
        }
    }
