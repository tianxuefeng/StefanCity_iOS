...
- (void)startLoading {
    ...
    [self.loadMoreButton setTitle:NSLocalizedString(msg_Load, nil) forState:UIControlStateNormal];
    [self.activityIndicatorView startAnimating];
}

- (void)endLoading {
    self.loadMoreButton.userInteractionEnabled = YES;
    [self.loadMoreButton setTitle:NSLocalizedString(msg_LoadMore, nil) forState:UIControlStateNormal];
...
- (UIButton *)loadMoreButton {
    if (!_loadMoreButton) {
        ...
        [_loadMoreButton setTitle:NSLocalizedString(msg_LoadMore, nil) forState:UIControlStateNormal];
