...
//        sBaiduAdview.autoplayEnabled = NO;
    if(type!= AdViewTypeRectangle){
        sBaiduAdview.frame = CGRectMake(0.0,-100.0,size.width,size.height);
    }else{
        sBaiduAdview.frame = CGRectMake(0.0, -500.0,size.width,size.height);
    }
